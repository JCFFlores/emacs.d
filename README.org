...
#+begin_src emacs-lisp
  (use-package mu4e
    :init
    (defvar mu4e-bookmarks-file "mu4e-bookmarks.data" "File holding bookmarks to be used in mu4e.
  The file is assumed to live inside the user emacs directory")
    (defvar mu4e-contexts-file "mu4e-contexts.data" "File holding contexts to be used in mu4e.
  The file is assumed to live inside the user emacs directory.
  The sexp held in the file is expected to be of the form (list (make-mu4e-context ...) (make-mu4e-context ...))")
    :custom
    ...
    (when-let* ((contexts (read-data-file (expand-file-name mu4e-contexts-file user-emacs-directory))))
