...
#+BEGIN_SRC emacs-lisp
  (use-package all-the-icons
    :after all-the-icons-dired-mode
    :ensure t)
#+END_SRC
** Dired configuration
...
encrypt it. Bind "C-c C-j" to new entry creation. This package depends on
org-mode so we eval its configuration after it said package has been loaded.
#+begin_src emacs-lisp
